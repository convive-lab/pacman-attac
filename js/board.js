...
function drawBoard(alternate) {
	...
	// }
	if(alternate==-1)ctx.strokeStyle="#193fff";
	else if(alternate==0)ctx.strokeStyle="#ed1b24";
	else if(alternate==1)ctx.strokeStyle="#005ca7";
	else if(alternate==2)ctx.strokeStyle="#61c2d0";
	else if(alternate==3)ctx.strokeStyle="#67af27";
	else if(alternate==4)ctx.strokeStyle="#eb4188";
